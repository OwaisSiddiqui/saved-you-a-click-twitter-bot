...
import { extractUrls, getAppClient, getBotClient, } from "./utils.js";
import { extract } from '@extractus/article-extractor';
const botClient = await getBotClient();
const botTweetReplyStandalone = async (client, tweet) => {
    ...
    const originalAnswer = await getAnswer(articleData.title, articleData.content);
